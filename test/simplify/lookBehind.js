...
describe('simplify/lookBehind()', function() {
    var i, l,
        tests = [
            [['e*(e1+e2)', 9],                ['e', ['e']]],
            [['eee*(e1+e2)', 11],             ['eee', ['eee']]],
            [['aaa+eee*(e1+e2)', 16],         ['eee', ['eee']]],
            [['(aaa+eee)*(e1+e2)', 18],       ['(aaa+eee)', ['aaa', 'eee']]],
            [['(aaa*aaa+eee)*(e1+e2)', 21],   ['(aaa*aaa+eee)', ['aaa*aaa', 'eee']]],
            [['a+(aaa*aaa+eee)*(e1+e2)', 23], ['(aaa*aaa+eee)', ['aaa*aaa', 'eee']]],
