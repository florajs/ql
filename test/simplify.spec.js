...
describe('simplify()', function () {
    var i,
        ...
        tests = [
            ...
            ['(e0+e1)*(e2+e3)*(e4+e5)', 'e0*e2*e4+e0*e2*e5+e0*e3*e4+e0*e3*e5+' + 'e1*e2*e4+e1*e2*e5+e1*e3*e4+e1*e3*e5'],
            ...
            ['((e2*e3)+(e5*e6))*((e8*e9)+(e11*e12))', 'e2*e3*e8*e9+e2*e3*e11*e12+' + 'e5*e6*e8*e9+e5*e6*e11*e12'],
            [
                '((e2*e3)+(e5*e6))*((e8*e9+e13)+(e11*e12))',
                'e2*e3*e8*e9+e2*e3*e13+e2*e3*e11*e12+' + 'e5*e6*e8*e9+e5*e6*e13+e5*e6*e11*e12'
            ],
            [
                '((e2*e3)+(e5*e6))*((e8*e9+e13)+((e11*e12)))',
                'e2*e3*e8*e9+e2*e3*e13+e2*e3*e11*e12+' + 'e5*e6*e8*e9+e5*e6*e13+e5*e6*e11*e12'
    ...
    for (i = 0, l = tests.length; i < l; i++) {
        it('should simplify ' + tests[i][0], factory(config(), tests[i][0], tests[i][1]));
    }
