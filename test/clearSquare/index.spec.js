...
describe('clearSquare()', function() {
    var i, l, 
        tests = [
            ...
            ['e0[(e1+e2)*(e3+e4)]',                                 'e0_1*e0_3+e0_2*e0_3+e0_1*e0_4+e0_2*e0_4'],
            ['e0[(e1[e2*e3]+e4)*(e5+e6)]',                          'e0_1_2*e0_1_3*e0_5+e0_4*e0_5+e0_1_2*e0_1_3*e0_6+e0_4*e0_6'],
            ['e0[(e1+e2[e3*e4])*(e5+e6)]',                          'e0_1*e0_5+e0_2_3*e0_2_4*e0_5+e0_1*e0_6+e0_2_3*e0_2_4*e0_6'],
            ['e0[(e1+e2)*(e3[e4*e5]+e6)]',                          'e0_1*e0_3_4*e0_3_5+e0_2*e0_3_4*e0_3_5+e0_1*e0_6+e0_2*e0_6'],
            ['e0[(e1+e2)*(e3+e4[e5*e6])]',                          'e0_1*e0_3+e0_2*e0_3+e0_1*e0_4_5*e0_4_6+e0_2*e0_4_5*e0_4_6'],
            ['e0[(e1[e2*e3]+e4[e5*e6])*(e7[e8*e9]+e10[e11*e12])]',  'e0_1_2*e0_1_3*e0_7_8*e0_7_9+e0_4_5*e0_4_6*e0_7_8*e0_7_9+e0_1_2*e0_1_3*e0_10_11*e0_10_12+e0_4_5*e0_4_6*e0_10_11*e0_10_12'],
            ['e0[(e1+e2)*(e3+e4)*(e5+e6)]',                         'e0_1*e0_3*e0_5+e0_2*e0_3*e0_5+e0_1*e0_4*e0_5+e0_2*e0_4*e0_5+e0_1*e0_3*e0_6+e0_2*e0_3*e0_6+e0_1*e0_4*e0_6+e0_2*e0_4*e0_6'],
            ...
            ['e0[e1*e2][e3*e4+e5*e6]e7*e8',                         'e0_1_3_7*e0_1_4_7*e0_2_3_7*e0_2_4_7*e8+' +
